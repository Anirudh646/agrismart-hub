...
import { Sprout, BarChart3, Shield, Mail, Phone, MapPin } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-background border border-border">
                ...
                <h3 className="font-semibold text-foreground mb-2">{t("about.aiTitle")}</h3>
                <p className="text-sm text-muted-foreground">{t("about.aiDesc")}</p>
              </div>
              <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-background border border-border">
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4">
                  <BarChart3 className="w-6 h-6 text-primary" />
                </div>
                <h3 className="font-semibold text-foreground mb-2">{t("about.marketTitle")}</h3>
                <p className="text-sm text-muted-foreground">{t("about.marketDesc")}</p>
              </div>
              <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-background border border-border">
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mb-4">
                  <Shield className="w-6 h-6 text-primary" />
                </div>
                <h3 className="font-semibold text-foreground mb-2">{t("about.schemesTitle")}</h3>
                <p className="text-sm text-muted-foreground">{t("about.schemesDesc")}</p>
              </div>
            </div>
          </div>
        </section>
